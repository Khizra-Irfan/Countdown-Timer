...
// `;
// async function main() {
//     console.log(chalk.bold.yellowBright("Please enter the time in hours, minutes, and seconds:"));
...
//     console.log(chalk.bold.magentaBright(`Current Time: ${hours}:${minutes}:${seconds}`));
//     console.log(chalk.bold.magentaBright(`Parsed Time String: ${timeString}`));
//     const [hour1, hour2, minute1, minute2, second1, second2] = timeString.split('');
//     console.log(chalk.bold.magentaBright(`Parsed Digits: ${hour1}, ${hour2}, ${minute1}, ${minute2}, ${second1}, ${second2}`));
...
//         console.log(
//             chalk.bold.blueBright(hour1Digits[i].padEnd(12)) +
//             chalk.bold.blueBright(hour2Digits[i].padEnd(12)) +
//             chalk.bold.whiteBright(colonDigits[i]?.padEnd(6) || ''.padEnd(6)) +
//             chalk.bold.yellowBright(minute1Digits[i].padEnd(12)) +
//             chalk.bold.yellowBright(minute2Digits[i].padEnd(12)) +
//             chalk.bold.whiteBright(colonDigits[i]?.padEnd(6) || ''.padEnd(6)) +
//             chalk.bold.redBright(second1Digits[i].padEnd(12)) +
//             chalk.bold.redBright(second2Digits[i])
//         );
//     }
// }
...
function printBigNumber(hours, minutes, seconds) {
    ...
    const colonDigits = colon.split('\n');
    for (let i = 0; i < hour1Digits.length; i++) {
        console.log(chalk.blueBright(hour1Digits[i].padEnd(12)) +
